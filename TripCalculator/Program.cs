...
*/
System.Console.WriteLine("How many people will be going?");
...
System.Console.WriteLine("");
System.Console.WriteLine($"Gallons needed: {GallonsNeeded}");
System.Console.WriteLine($"Fuel cost: {FuelCost}");
System.Console.WriteLine("");
System.Console.WriteLine("");
...
System.Console.WriteLine($"Price per pizza: {PerPizzaCost}");
System.Console.WriteLine("");
System.Console.WriteLine("");
System.Console.WriteLine($"Total slices: {TotalSlices}");
...
System.Console.WriteLine($"Tax withheld: {TaxWithheld}");
System.Console.WriteLine($"Take home pay: {TakeHome}");
System.Console.WriteLine("");
System.Console.WriteLine("");
System.Console.WriteLine("=== Part 4: The Whole Trip ===");
System.Console.WriteLine($"Trip total: {TripTotal}");
System.Console.WriteLine($"Cost per person {CostPerPerson}");
System.Console.WriteLine($"Take home pay per hour: {TakeHomePayPerHour}");
System.Console.WriteLine($"Hours you must work to cover your share: {HoursNeeded}");